...
public class SanPhamChiTietRepository {
    ...
    public ArrayList<ChiTietGiay> getAllSanPham() {
        ...
        String sql = " SELECT dbo.CHITIETGIAY.Id, dbo.SANPHAM.Ma, dbo.SanPham.Ten, dbo.DANHMUC.Ten,\n"
   ...
   public ArrayList<ChiTietGiay> getAllChiTietSanPham() {
    ArrayList<ChiTietGiay> listctg = new ArrayList<>();
    String sql = "SELECT dbo.CHITIETGIAY.Id, dbo.SANPHAM.Ten AS TenSanPham,  dbo.DANHMUC.Ten AS TenDanhMuc,\n"
            + "dbo.Size.KichCo, dbo.MAUSAC.MauSac,\n"
            + "dbo.CHATLIEU.Ten AS TenChatLieu, dbo.NSX.Ten AS TenNSX, dbo.DE.Ten AS TenDe, dbo.CHITIETGIAY.SoLuong, dbo.CHITIETGIAY.GiaBan, dbo.CHITIETGIAY.Mota, dbo.CHITIETGIAY.TrangThai\n"
            + "FROM dbo.CHITIETGIAY\n"
            + "INNER JOIN dbo.SanPham ON dbo.CHITIETGIAY.IdSanPham = dbo.SanPham.Id\n"
            + "INNER JOIN dbo.DANHMUC ON dbo.CHITIETGIAY.IdDanhMuc = dbo.DANHMUC.Id\n"
