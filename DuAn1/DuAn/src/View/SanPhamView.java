...
public class SanPhamView extends javax.swing.JFrame {
    ...
    ArrayList<ChiTietGiay> listsp = sanPhamService.getAllSanPhamService();

    public SanPhamView() {
        initComponents();
        loadtable(listsp);
    }
// public void loadtable(ArrayList<SanPham> sanPham) {
...
//                sp.getMa(),
//                sp.getTen(),
//                sp.getTrangThai()==1?"Hoat dong":"Khong Hoat Dong",};
//            model.addRow(data);
//        }
//        listsp = sanPham;
//    }
    ...
    public void loadtable(ArrayList<ChiTietGiay> ctg) {
        ...
        for (ChiTietGiay chitietgiay : ctg) {
            Object[] data = new Object[]{
                chitietgiay.getIdSanPham().getId(),
