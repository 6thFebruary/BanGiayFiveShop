...
public class FromNhanVien extends javax.swing.JFrame {
    ...
    /**
     * Creates new form NhanVienRepository
     */
    ...
    public void loadTable(){
        ArrayList<NguoiDung> nv = this.nvRepo.getList();
        DefaultTableModel dfm = (DefaultTableModel)this.tblNguoiDung.getModel();
        dfm.setRowCount(0);
        for (NguoiDung nd : nv) {
            Object[] row = {
                nd.getMaNguoiDung(),
                ...
                nd.getSdtNguoiDung(),
                nd.getGioiTinhNguoiDung(),
                nd.getDiaChiNguoiDung(),
                nd.getMatKhauNguoiDung(),
                nd.getTrangThaiNguoiDung() == 1? "Hoat Dong" : "Khong Hoat Dong",
            };
                    dfm.addRow(row);
        }
    }
